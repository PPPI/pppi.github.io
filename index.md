...
1. POSIT: A tool that makes use of a CRF-biLSTM model to segment and tag text that mixes English and code snippets. It was trained on a compination of C code and StackOverflow. [GitHub Link](https://github.com/PPPI/POSIT)
